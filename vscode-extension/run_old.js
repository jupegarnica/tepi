...
`;
    const languages = ['javascript', 'javascriptreact', 'typescript', 'typescriptreact', 'vue', 'php', 'haxe', 'http'];
    ...
    toggleGM.command = 'vscode-tepi.toggle';
    context.subscriptions.push(toggleGM);
    context.subscriptions.push(vscode.commands.registerCommand('vscode-tepi.toggle', () => {
